### Made signal names lowercase and consistent
### with old Nexys 4 DDR naming convention - fischerm 5/23/22
...
#set_property -dict { PACKAGE_PIN G4  IOSTANDARD LVCMOS15 } [get_ports { brst }]; #IO_L12N_T1_MRCC_35 Sch=cpu_resetn
